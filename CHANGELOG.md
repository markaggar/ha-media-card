...
- **Sequential Sorting**: Improved handling of files without datetime stamps (appear last in both asc/desc order)
- **Position Indicator**: Enhanced accuracy and stability in sequential mode
